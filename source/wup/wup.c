...
void WUP_Init()
{
    ...
    *(vu32*)0xF00019DC = 0;
    ...
    REG_GPIO_CAMERA = GPIO_SLEW_FAST;
    ...
    REG_GPIO_UNK74 = GPIO_SLEW_FAST | GPIO_ALT_FUNCTION;
    REG_GPIO_UNK78 = GPIO_ALT_FUNCTION;

    REG_GPIO_UNKDC = GPIO_SLEW_FAST | GPIO_ALT_FUNCTION;
    REG_GPIO_UNKE0 = GPIO_SLEW_FAST | GPIO_ALT_FUNCTION;
