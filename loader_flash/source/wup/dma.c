...
static volatile u8 DMA_IRQFlag[5];
...
void SPDMA0_IRQHandler(void* userdata)
{
    REG_SPDMA_START(0) = SPDMA_STOP;
    DMA_IRQFlag[0] = 1;
}

void SPDMA1_IRQHandler(void* userdata)
{
    REG_SPDMA_START(1) = SPDMA_STOP;
    DMA_IRQFlag[1] = 1;
}

void GPDMA0_IRQHandler(void* userdata)
{
    REG_GPDMA_START(0) = GPDMA_STOP;
    DMA_IRQFlag[2] = 1;
}

void GPDMA1_IRQHandler(void* userdata)
{
    REG_GPDMA_START(1) = GPDMA_STOP;
    DMA_IRQFlag[3] = 1;
}

void GPDMA2_IRQHandler(void* userdata)
{
